...
class HandTracker:
    ...
    def postProcess(self, hand_landmarks, major_hand_idx):
        ...
        if hand_landmarks:
            # for the thumb
            if hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.INDEX_FINGER_TIP].y < hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.WRIST].y and hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.PINKY_TIP].y < hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.WRIST].y:
            ...
            elif hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.PINKY_TIP].y < hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.WRIST].y and hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.INDEX_FINGER_TIP].y > hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.WRIST].y:
                self.thumb_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_TIP].y
                self.thumb_below_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_IP].y
                self.thumb_before_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_MCP].y
                self.thumb_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_CMC].y
                if self.thumb_tip > self.thumb_below_tip:
                    self.thumb_status = "1"
                    self.output[0] = 0
                elif self.thumb_tip > (self.thumb_before_end) and self.thumb_tip <= (self.thumb_below_tip):
                ...
                # for the index finger
                self.index_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.INDEX_FINGER_TIP].x
                self.index_below_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.INDEX_FINGER_DIP].x
                self.index_before_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.INDEX_FINGER_PIP].x
                self.index_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.INDEX_FINGER_MCP].x
                if self.index_tip < self.index_below_tip:
                    self.index_status = "1"
                    self.output[1] = 0
                elif self.index_tip < (self.index_before_end) and self.index_tip >= (self.index_below_tip):
                ...
                # for the middle finger
                self.mid_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.MIDDLE_FINGER_TIP].x
                self.mid_below_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.MIDDLE_FINGER_DIP].x
                self.mid_before_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.MIDDLE_FINGER_PIP].x
                self.mid_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.MIDDLE_FINGER_MCP].x
                if self.mid_tip < self.mid_below_tip:
                    self.mid_status = "1"
                    self.output[2] = 0
                elif self.mid_tip < (self.mid_before_end) and self.mid_tip >= (self.mid_below_tip):
                ...
                # for the ring finger
                self.ring_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.RING_FINGER_TIP].x
                self.ring_below_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.RING_FINGER_DIP].x
                self.ring_before_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.RING_FINGER_PIP].x
                self.ring_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.RING_FINGER_MCP].x
                if self.ring_tip < self.ring_below_tip:
                    self.ring_status = "1"
                    self.output[3] = 0
                elif self.ring_tip < (self.ring_before_end) and self.ring_tip >= (self.ring_below_tip):
                ...
                # for the pinky finger
                self.pinky_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.PINKY_TIP].x
                self.pinky_below_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.PINKY_DIP].x
                self.pinky_before_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.PINKY_PIP].x
                self.pinky_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.PINKY_MCP].x
                if self.pinky_tip < self.pinky_below_tip:
                    self.pinky_status = "1"
                    self.output[4] = 0
                elif self.pinky_tip < (self.pinky_before_end) and self.pinky_tip >= (self.pinky_below_tip):
                ...
                if self.pinky_tip > self.pinky_below_tip:
                    ...
                    self.pinky_status = "0"
                    self.output[4] = 180
            elif hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.INDEX_FINGER_TIP].y < hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.WRIST].y and hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.PINKY_TIP].y > hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.WRIST].y:
                self.thumb_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_TIP].y
                self.thumb_below_tip = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_IP].y
                self.thumb_before_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_MCP].y
                self.thumb_end = hand_landmarks[major_hand_idx].landmark[mp_hands.HandLandmark.THUMB_CMC].y
